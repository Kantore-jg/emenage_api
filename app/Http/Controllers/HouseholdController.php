...
class HouseholdController extends Controller
{
    ...
    {
        $query = Household::select('households.*')
            ->join('users', 'households.chef_id', '=', 'users.id')
            ->selectRaw('users.nom as chef_nom, users.telephone as chef_telephone')
            ...
            ->groupBy('households.id', 'users.nom', 'users.telephone');
    ...
    {
        $stats = Household::select('quartier')
